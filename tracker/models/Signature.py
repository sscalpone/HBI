...
"""Model for the record of who is filling out each form. Each Signature has an exam_id for reference. The exam cannot be saved without it.
"""
class Signature(models.Model):
    ...
    # The human-readable version of the signature - the name of the person filling out the form.
